               ...
               const mat4& lightProjectionMatrix)
{
	...
	//labhelper::setUniformSlow(currentShaderProgram, "viewSpaceLightDir", viewSpaceLightPosition);
	//labhelper::setUniformSlow(currentShaderProgram, "spotOuterAngle", spotOut);
}
